...
{
    public class CopyTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener
    {
        private readonly CopySelectionCommandController controller = new CopySelectionCommandController();

        public CopyTool() : base("CopyTool")
        { }
