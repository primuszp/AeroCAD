...
{
    public class ArcTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener, ILayerBoundTool
    {
        private readonly ArcCommandController controller;

        public Layer ActiveLayer { get; set; }

        public ArcTool() : base("ArcTool")
        {
            controller = new ArcCommandController(() => ActiveLayer ?? GetFirstLayer());
        }
        ...
        {
            return ApplyResult(controller.TrySubmitToken(this,
                Primusz.AeroCAD.Core.Editor.CommandInputToken.Point(FormatPoint(point), point)));
        }
