...
{
    public class LineTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener, ILayerBoundTool
    {
        private readonly LineCommandController controller;

        public Layer ActiveLayer { get; set; }

        public LineTool() : base("LineTool")
        {
            controller = new LineCommandController(() => ActiveLayer ?? GetFirstLayer());
        }
