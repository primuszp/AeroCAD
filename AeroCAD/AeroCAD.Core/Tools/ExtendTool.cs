...
{
    public class ExtendTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener
    {
        private readonly ExtendCommandController controller = new ExtendCommandController();

        public ExtendTool() : base("ExtendTool")
        {
        }
