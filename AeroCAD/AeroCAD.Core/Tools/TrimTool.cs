...
{
    public class TrimTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener
    {
        private readonly TrimCommandController controller = new TrimCommandController();

        public TrimTool() : base("TrimTool")
        {
        }
