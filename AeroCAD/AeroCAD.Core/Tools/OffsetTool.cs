...
{
    public class OffsetTool : InteractiveCommandToolBase, IMouseListener, IKeyboardListener
    {
        private readonly OffsetCommandController controller = new OffsetCommandController();

        public OffsetTool() : base("OffsetTool")
        {
        }
