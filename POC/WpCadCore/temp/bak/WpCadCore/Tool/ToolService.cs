...
namespace WpCadCore.Tool
{
    class ToolService : IToolService
    {
        ...
        private void InitializeService()
        {
            ...
            this.ModelSpaceView.PreviewMouseLeftButtonDown += new MouseButtonEventHandler(ModelSpaceView_PreviewMouseLeftButtonDown);
            this.ModelSpaceView.PreviewMouseLeftButtonUp += new MouseButtonEventHandler(ModelSpaceView_PreviewMouseLeftButtonUp);
        ...
        private void ModelSpaceView_PreviewMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
        ...
        private void ModelSpaceView_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            foreach (ITool tool in tools.Values)
            {
                if (tool is IMouseListener)
